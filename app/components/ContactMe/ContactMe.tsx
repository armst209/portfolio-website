...
const ContactMe = () => {
    return (
        <section id="contact" className="flex flex-col min-h-150 w-full justify-center items-center p-4 mt-10 lg:p-6">
            ...
            <div className="relative h-auto border-[.5px] border-[hsl(240,4,16)] rounded-lg w-full p-4 ">
                ...
                <div className="relative flex flex-col items-center h-full lg:flex-row">
                    <div className='z-10 relative w-full flex flex-col justify-center items-center mb-4 md:h-50 lg:items-left lg:mr-4 lg:h-100'>
                        <Image src={CircledScribble} className="scribble-color-filter absolute inset-0 rotate-25 mt-25 mr-10 md:rotate-0 md:mt-0 lg:rotate-0" fill={true} style={{ objectFit: "contain" }} alt="circle scribble" />
                        <Image src={CircledScribble} className="scribble-color-filter absolute inset-0 rotate-150 mt-28 ml-5 md:hidden" fill={true} style={{ objectFit: "contain" }} alt="circle scribble" />
