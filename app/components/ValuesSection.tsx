            ...
            <div className="h-auto flex flex-col items-center justify-evenly border-[.5px] border-[hsl(240,4,16)] rounded-xl p-4 bg-background xl:flex-row xl:h-70">
                <div className="w-full flex flex-col h-full z-10 px-4 py-6 sm:flex-row ">
                    ...
                    <div className="w-full h-full flex flex-col justify-center items-start pl-4">
                        ...
                        <h2 className="text-md lg:text-xl">
                            I build with modern frameworks and best practices to create fast,
                ...
                <div className="w-full flex flex-col h-full px-4 py-6 z-10 sm:flex-row lg:justify-start">
                    ...
                    <div className="w-full h-full flex flex-col justify-center items-start pl-4">
                        ...
                        <h2 className="text-md lg:text-xl">
                            Accessibility is at the core of what I do. I build inclusive experiences
                ...
                <div className="w-full flex flex-col h-full px-4 py-6 z-10 sm:flex-row">
                    ...
                    <div className="w-full h-full flex flex-col justify-center items-start pl-4">
                        <h1 className="pb-6 w-full text-2xl font-bold lg:text-3xl">
                            Visually Pleasing
                        </h1>
                        <h2 className="text-md lg:text-xl">
                            Clean, thoughtful design and attention to detail.{' '}
                        </h2>
                    </div>
                </div>
            </div>
