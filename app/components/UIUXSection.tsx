...
const UIUXSection = () => {
    return (
        <section className="pt-5 pb-6 pl-4 pr-4 w-full flex justify-center">
            <div className="w-full h-auto flex flex-col items-center justify-evenly border border-(--light-border) rounded-xl lg:w-[80%] 2xl:flex-row xl:h-70 dark:border-(--dark-border)">
