...
const UIUXSection = () => {
    return (
        <section className="pt-5 pb-6 pl-4 pr-4 w-full flex justify-center">
            <div className="w-full h-auto flex flex-col items-center justify-evenly border-[.5px] border-[hsl(240,4,16)] rounded-xl lg:w-[80%] 2xl:flex-row xl:h-70">
                ...
                <div className="z-10 w-full border-b-[.5px] border-b-[hsl(240,4,16)] 2xl:border-b-0 xl:border-r-[.5px] xl:border-r-[hsl(240,4,16)] 2xl:h-full 2xl:w-auto"></div>
                <div className="flex p-2 flex-col w-full md:flex-row xl:w-[66.6%]">
                    ...
                    <div className="p-2 grid grid-cols-1 w-full lg:w-[50%]">
                        ...
                        <div className="flex flex-row items-center justify-start xxs:justify-center"><Image src={CheckIcon} alt="contact icon" width={20} className="mr-4 icon-emerald-filter" /><p className="text-lg">User Testing</p></div>
                        <div className="flex flex-row items-center justify-start xxs:justify-center"><Image src={CheckIcon} alt="contact icon" width={20} className="mr-4 icon-emerald-filter" /><p className="text-lg">Color Selection</p></div>
                    </div>
                </div>
            </div>
        </section>
