                ...
                <div className=" flex justify-between p-4 lg:items-center w-full">
                    ...
                    <div className="relative">
                        ...
                        <div
                            ...
                            className={`w-full h-screen flex fixed inset-0 bg-background z-50 transition-transform duration-300 ease-out shadow(12px 9px 18px 5px rgba(0,0,0,0.84)) transform ${isOpen ? ' translate-x-0' : 'translate-x-full'} lg:hidden`}
                        >
                            <button
