        ...
        <section className="flex flex-col min-h-200 w-full justify-center pt-25 p-4 pb-25 border-b-[.5px] border-b-[hsl(240,4,16)]">
            ...
            <div className="relative flex flex-col items-center justify-center xl:flex-row">
                <div className="z-10 w-full relative border-[.5px] border-[hsl(240,4,16)] p-4 mb-2 rounded-xl h-auto pb-30 lg:mr-2 xl:h-110">
                    <Image src={BackgroundSwirls} alt="background image" fill style={{ objectFit: "cover" }} className="absolute inset-0" />
                    ...
                    <Image src={SkillsIcon} width={50} alt="skillset icon" className="z-10 icon-emerald-filter absolute bottom-0 right-0 mr-4 mb-4" />
                </div>
                ...
                <div className="relative w-full border-[.5px] border-[hsl(240,4,16)] p-4 mb-2 rounded-xl h-110 pb-10 lg:mr-2">
                    ...
                    <Image src={TechnologiesIcon} width={50} alt="technologies icon" className="icon-emerald-filter absolute bottom-0 right-0 mr-4 mb-4" />
                </div>
                ...
                <div className="w-full relative border-[.5px] border-[hsl(240,4,16)] p-4 mb-2 rounded-xl h-110 pb-10 xl:h-110">
                    ...
                    <Image src={DesignIcon} width={50} alt="skillset icon" className="icon-emerald-filter absolute bottom-0 right-0 mr-4 mb-4" /></div>
            </div>
