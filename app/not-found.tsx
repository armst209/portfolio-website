    ...
    return (
        <div className='relative h-screen flex flex-col justify-center items-center p-4 w-full'>
            ...
            <div className="z-10 flex flex-row items-center justify-center">
                <Image src={NotFoundIcon} alt="404 icon" width={50} className="icon-emerald-filter pr-4" />|<h1 className="text-3xl pl-4 font-bold">Not Found</h1>
            </div>
            <h2 className="mb-5 z-10">The page you are looking for does not exist.</h2>
